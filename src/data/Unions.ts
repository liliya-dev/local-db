export default [
    ...
    datasets: [
      {
        ...
        shortDescription:
          'Insight into the sleeping patterns of adults in the UK',
        longDescription:
          'UK-wide sleeping data from adults between 18 and 50 grouped by age range and gender',
        duration: 'Annual',
        region: 'UK',
        pricePerDay: 100,
        pricePerWeek: 500,
  ...
  },
  {
    ...
    teaser:
      'From city planning to electric charging insights. Browse the world of Automotive data',
    summary:
      'MOBI and our members are creating blockchain-based standards to identify vehicles, people, businesses, and the Trusted Trip with the goal of making transportation more efficient, equitable, decentralized, and sustainable.',
    ...
    datasets: [
      {
        ...
        longDescription:
          'European vehicle CO2 emissions, collected from 50 cities and 20 countries',
        duration: 'Annual',
        region: 'EMEA',
        pricePerDay: 100,
        pricePerWeek: 500,
      ...
      },
      {
        ...
        shortDescription:
          'This dataset takes a look at the urban mobility trends for metro areas.',
        longDescription:
          'The Smart Mobility provides insight into transportation technologies and services for citizens, goods, and logistics',
        duration: 'Monthly',
  ...
  },
  {
    ...
    summary:
      'Unbanx is a platform that allows users to link their bank accounts to contribute anonymized transaction data to the Unbanx Data Union.',
    ...
    datasets: [
      {
        ...
        longDescription:
          'Surge in e-commerce spending.  Preference for trusted brands.  Decline in discretionary spending, trading down. Larger basket, reduced shopping frequency. Shift to stores closer to home.  Polarization of sustainability',
        duration: 'Monthly',
        region: 'Global',
        pricePerDay: 900,
        pricePerWeek: 1100,
  ...
  },
  {
    ...
    summary:
      'Mauris finibus, purus nec varius lobortis, lectus lectus elementum ante, id lacinia sapien ipsum et nulla. Proin facilisis velit sit amet urna bibendum vestibulum. Aliquam eu ullamcorper purus. Sed id libero neque.',
    ...
    datasets: [
      ...
      },
      {
        ...
        longDescription:
          'Indicators from the Opinions and Lifestyle Survey (OPN) of whether people experienced shortages of goods such as food, medicine, or fuel when shopping in EMEA',
        duration: 'Weekly',
        region: 'EMEA',
        pricePerDay: 100,
        pricePerWeek: 400,
  ...
  },
  {
    ...
    recentArticles: [
      ...
      {
        title:
          'OzoneAI Launch at 2019 TechCrunch Disrupt (Startup Battlefield)',
    ...
    datasets: [
      ...
      },
      {
        ...
        longDescription:
          'Brand key performance indicators for brands in Germany, the United States, and the UK. This tool is ideal for brand strategists, product managers, media planners and everyone who works with brands.',
        duration: 'Weekly',
        region: 'EMEA',
        pricePerDay: 100,
        pricePerWeek: 400,
  ...
  },
  {
    ...
    datasets: [
      ...
      },
      {
        ...
        longDescription:
          "The Top Cities report is compiled by UN Women, which ranks the top ten cities in the world that women will have the best opportunities to fully realize their rights.\n\nWhile not an exhaustive list, the top ten cities have a combination of infrastructure, political will, women's participation, social awareness and press freedom",
        duration: 'Weekly',
        region: 'EMEA',
        pricePerDay: 100,
        pricePerWeek: 400,
      ...
      },
      {
        ...
        longDescription:
          'The fall of IoT superstar smart fridges and the resurgence of game consoles as a cybersecurity threat represent two of the cyber security trends that have dominated the headlines of late. David Constable has been tracking the issue for TechWatch and has the details.',
        duration: 'Monthly',
        region: 'EMEA',
        pricePerDay: 100,
        pricePerWeek: 400,
      ...
      },
      {
        ...
        shortDescription: 'FinTech',
        longDescription:
          'Combine location data with business, consumer and contextual information to ensure relevant ad content reaches the right audience at the right time',
        duration: 'Annual',
        region: 'Global',
        pricePerDay: 100,
        pricePerWeek: 400,
      ...
      },
      {
        ...
        shortDescription: 'FinTech',
        longDescription:
          'Audiotech refers to products, services, and technologies that represent a shift away from the 3D audio "flat" approach and toward products that can adapt to different audio environments, as well as other adaptable environments, such as homes, businesses, cars, and airplanes.',
        duration: 'Annual',
        region: 'Global',
        pricePerDay: 100,
        pricePerWeek: 400,
